  ...
  try {
    ...
    switch (message.Type) {
      ...
      case 'round_results':
        ...
        const winnersCount = message.Results.filter(
          r => r.Result == 'won'
        ).length;
        ...
        return Effect.gen(function* () {
          ...
          if (isLoadResultsResponse(r)) {
            ...
            if (loadResults) {
              ...
              gameState.dealerHand = loadResults.allDealerCards
              ...
              ws.onmessage = event => {
                try {
                  ...
                  switch (processed.type) {
                    case 'NEW_ROUND':
                      gameState.dealerHand = processed.dealerCards
                        .map(convertCardCodeToCard)
                        .reverse();
                    ...
                    case 'PLAYER_CARDS':
                      ...
                      gameState.totalStartingCards =
                        processed.totalStartingCards;
                      break;
                    case 'ROUND_RESULTS':
