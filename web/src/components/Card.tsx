...
function FlipCard({ initialCard = 'AS', position }) {
  ...
  return (
    <group position={position} ref={cardRef} rotation={[0, Math.PI, 0]}>
...
export function PlayCard({ card, position }) {
  return <FlipCard initialCard={card} position={position} />
}
