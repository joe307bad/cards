...
export default function MinimalTable(props: {
  ...
  const disableButtons =
    ...
    (currentPlayerHand &&
      (playerStatus?.text === 'BUST' || playerStatus?.text === 'BLACKJACK!')) ||
    standing;
          ...
          <div className="min-h-[150px] rounded-none bg-[transparent] flex flex-col">
            <div className="flex mb-3 w-full">
              <div className="flex-1 flex items-center flex-row">
                ...
                {dealerStatus && (
                  <p
                    className={`${dealerStatus.color} text-sm pl-2 align-left font-semibold`}
                  >
                    {dealerStatus.text}
                  </p>
                )}
                  ...
                  <div>
                    {(() => {
                      return (
                        playerStatus && (
                          <p
                            className={`${playerStatus.color} text-sm font-semibold`}
                          >
                            {playerStatus.text}
                          </p>
                        )
